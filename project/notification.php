...
$getcomments=  mysqli_query($mysqli, "SELECT * FROM comments WHERE commented_to='$_post_id' and open='0' ORDER BY id DESC LIMIT 10 ")or Die(mysqli_error($mysqli));
            ...
            $sql1=mysqli_query($mysqli, "UPDATE comments SET open='1' where id = '$id' ");
...
$getreplies=  mysqli_query($mysqli, "SELECT * FROM replies WHERE parent_comment_id='$_comment_id' and open='0' ")or Die(mysqli_error($mysqli));
          ...
          $sql1=mysqli_query($mysqli, "UPDATE replies SET open='1' where reply_id = '$reply_id' ");

                echo "
                    <div class='reply_in_comments'>
                <ul >
    <li style='list-style-type : none;color:grey;font-family: Verdana;
